...
// Bulletproof SEO hook with comprehensive React validation
export const useBulletproofSEO = ({ title, description, keywords }: SEOProps) => {
  // Critical: Ensure React and useEffect are available before proceeding
...
export const useSafeSEO = useBulletproofSEO;