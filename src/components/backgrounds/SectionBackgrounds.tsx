...
export const HeroBackground = () => (
  <div className="absolute inset-0 z-0">
    <div className="absolute inset-0 bg-gradient-to-br from-orange-200/40 via-blue-200/40 to-purple-200/40"></div>
    <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-pink-200/20 to-cyan-200/30"></div>
    <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-orange-300/30 to-blue-300/30 rounded-full blur-3xl"></div>
    <div className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-tr from-blue-300/25 to-purple-300/25 rounded-full blur-3xl"></div>
    <div className="absolute top-10 left-10 w-32 h-32 border-2 border-orange-400/40 rounded-lg rotate-12 animate-pulse"></div>
    <div className="absolute bottom-10 right-10 w-24 h-24 border-2 border-blue-400/40 rounded-full animate-pulse"></div>
  </div>
);
...
export const AITechnologyBackground = () => (
  <div className="absolute inset-0 z-0">
    <div className="absolute inset-0 bg-gradient-to-r from-green-200/50 to-teal-200/50"></div>
    <div className="absolute top-10 left-10 w-32 h-32 border-4 border-green-500/60 rounded-lg rotate-12 animate-pulse"></div>
    <div className="absolute bottom-10 right-10 w-24 h-24 border-4 border-teal-500/60 rounded-full animate-pulse"></div>
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-green-300/40 rounded-full"></div>
  </div>
);
