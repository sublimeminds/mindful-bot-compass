...
interface InternationalizedEnhancedSmartAnalysisStepProps {
  onNext: () => void;
  onBack: () => void;
  onboardingData: any;
}
...
const InternationalizedEnhancedSmartAnalysisStep = ({ onNext, onBack, onboardingData }: InternationalizedEnhancedSmartAnalysisStepProps) => {
  ...
  const performEnhancedAnalysis = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Enhanced analysis complete!",
      });
    } catch (error) {
    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">{t('onboarding.smartAnalysis.analyzing')}</h2>
          <p className="text-muted-foreground">
            {t('onboarding.smartAnalysis.analyzingSubtext')}
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">{t('onboarding.smartAnalysis.title')}</h2>
        <p className="text-muted-foreground">
          {t('onboarding.smartAnalysis.subtitle')}
        </p>
      </div>
      ...
      <Card className="border-harmony-200 bg-harmony-50">
        <CardHeader>
          <CardTitle className="flex items-center space-x-2 text-harmony-800">
            ...
            <span>{t('onboarding.smartAnalysis.planTitle')}</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>{t('onboarding.smartAnalysis.riskAssessment')}</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>{t('onboarding.smartAnalysis.insights')}</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>{t('onboarding.smartAnalysis.cultural')}</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>{t('onboarding.smartAnalysis.recommendations')}</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="flex justify-between">
        ...
        >
          {t('onboarding.smartAnalysis.continueToMatching')}
        </Button>
      </div>
    </div>
  );
