  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-2">Therapy Approaches</h2>
      ...
      <div className="bg-harmony-50 p-4 rounded-lg border border-harmony-200">
        <p className="text-sm text-harmony-800">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-3 mb-3">
                      <IconComponent className="h-6 w-6 text-harmony-600" />
                      <span className="font-medium text-base">{preference.shortName}</span>
                    </div>
