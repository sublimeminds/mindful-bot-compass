-- Add Anthropic API key as a secret (this will be handled via Supabase dashboard)
-- No database changes needed for API key storage

-- Enhance AI configuration tables for advanced features
