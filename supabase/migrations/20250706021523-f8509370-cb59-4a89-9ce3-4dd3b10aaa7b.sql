...
-- Expand notification types beyond basic ones
...
CREATE TABLE public.integration_webhooks (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  integration_id UUID NOT NULL REFERENCES public.platform_integrations(id),
...
CREATE TABLE public.notification_deliveries (
  ...
  platform_integration_id UUID REFERENCES public.platform_integrations(id),
